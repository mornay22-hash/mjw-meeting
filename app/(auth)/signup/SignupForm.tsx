...
export default function SignupForm({ logoSrc }: { logoSrc: string }) {
    ...
    <div style={{ minHeight: '100vh', background: 'var(--black)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ background: 'var(--ink2)', border: '1px solid var(--line)', borderRadius: 12, padding: '28px 28px 24px' }}>
          {done ? (
            <>
              <h1 style={{ fontSize: 20, fontWeight: 400, color: 'var(--paper)', margin: '0 0 8px', fontFamily: 'var(--font-fraunces, Georgia, serif)' }}>
                Check your email
              </h1>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                ...
                {error && <p style={{ fontSize: 12, color: '#e05c5c', margin: '-8px 0 0' }}>{error}</p>}
